...
class HausnerMosaicMaker:
    ...
    def _design_mosaic(img, density_map, config, debug_dir):
        ...
        from Hausner_level_lines import get_level_lines
        h, w = img.shape[:2]
        ...
        centers, label_map = oriented_tesselation_with_edge_avoidance(edge_map, direction_field, density_map,
                                                                      ...
                                                                      search_area_factor=2, cut_by_edges=True, debug_dir=debug_dir)
...
if __name__ == '__main__':
    ...
    mosaic_maker = HausnerMosaicMaker.make_mosaic(configs, os.path.join("outputs", "Hausner_rectangle_fit", configs.get_str()))
